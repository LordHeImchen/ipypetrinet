...
# -*- coding: utf-8 -*-
#
# ipypetrinet documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipypetrinet', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipypetrinetdoc'
...
latex_documents = [
    (master_doc, 'ipypetrinet.tex', 'ipypetrinet Documentation',
     'Jakob Bucksch', 'manual'),
]
